...
db.serialize(() => {
    ...
    // Számlák beszúrása (3 számla vevőnként)
    const szamlak = [
        // XYZ Zrt. számlái
        [1, 1, 'SZ-2025-001', '2025-01-15', '2025-01-15', '2025-02-14', 120000, 27],
        [1, 1, 'SZ-2025-002', '2025-02-10', '2025-02-10', '2025-03-12', 85000, 27],
        [1, 1, 'SZ-2025-003', '2025-03-05', '2025-03-05', '2025-04-04', 95000, 27],
        
        // Teszt Bt. számlái
        [1, 2, 'SZ-2025-004', '2025-01-20', '2025-01-20', '2025-02-19', 45000, 18],
        [1, 2, 'SZ-2025-005', '2025-02-15', '2025-02-15', '2025-03-17', 67000, 18],
        [1, 2, 'SZ-2025-006', '2025-03-10', '2025-03-10', '2025-04-09', 78000, 18],
        
        // Minta Kft. számlái
        [1, 3, 'SZ-2025-007', '2025-01-25', '2025-01-25', '2025-02-24', 155000, 27],
        [1, 3, 'SZ-2025-008', '2025-02-20', '2025-02-20', '2025-03-22', 89000, 27],
        [1, 3, 'SZ-2025-009', '2025-03-15', '2025-03-15', '2025-04-14', 134000, 27]
    ];
